...
function initSlideShow() {
	jQuery('div.tools').fadeGallery({
		slides: 'div.gallery-landing-big > ul > li',
		pagerLinks: '.gallery-landing-prev li',
	...
	$('div.gallery-tools').fadeGallery({
		slides: 'ul.gallery-tools > li',
		pagerLinks: 'ul.gallery-prev li',
		switchSimultaneously: true,
		disableWhileAnimating: false,
		autoRotation: false,
		autoHeight: false,
